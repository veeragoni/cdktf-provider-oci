// https://registry.terraform.io/providers/hashicorp/oci/7.19.0/docs/data-sources/managed_kafka_kafka_cluster_config_version
...
export interface DataOciManagedKafkaKafkaClusterConfigVersionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/7.19.0/docs/data-sources/managed_kafka_kafka_cluster_config_version#id DataOciManagedKafkaKafkaClusterConfigVersion#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/7.19.0/docs/data-sources/managed_kafka_kafka_cluster_config_version#kafka_cluster_config_id DataOciManagedKafkaKafkaClusterConfigVersion#kafka_cluster_config_id}
  */
  readonly kafkaClusterConfigId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/7.19.0/docs/data-sources/managed_kafka_kafka_cluster_config_version#version_number DataOciManagedKafkaKafkaClusterConfigVersion#version_number}
  */
  readonly versionNumber: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/7.19.0/docs/data-sources/managed_kafka_kafka_cluster_config_version oci_managed_kafka_kafka_cluster_config_version}
*/
export class DataOciManagedKafkaKafkaClusterConfigVersion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciManagedKafkaKafkaClusterConfigVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/7.19.0/docs/data-sources/managed_kafka_kafka_cluster_config_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/7.19.0/docs/data-sources/managed_kafka_kafka_cluster_config_version oci_managed_kafka_kafka_cluster_config_version} Data Source
  *
  * @param scope The scope in which to define this construct
