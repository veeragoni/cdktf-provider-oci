// https://registry.terraform.io/providers/hashicorp/oci/7.19.0/docs/data-sources/network_firewall_network_firewall_policy_service_list
...
export interface DataOciNetworkFirewallNetworkFirewallPolicyServiceListConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/7.19.0/docs/data-sources/network_firewall_network_firewall_policy_service_list#name DataOciNetworkFirewallNetworkFirewallPolicyServiceList#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/7.19.0/docs/data-sources/network_firewall_network_firewall_policy_service_list#network_firewall_policy_id DataOciNetworkFirewallNetworkFirewallPolicyServiceList#network_firewall_policy_id}
  */
  readonly networkFirewallPolicyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/7.19.0/docs/data-sources/network_firewall_network_firewall_policy_service_list oci_network_firewall_network_firewall_policy_service_list}
*/
export class DataOciNetworkFirewallNetworkFirewallPolicyServiceList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciNetworkFirewallNetworkFirewallPolicyServiceList that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/7.19.0/docs/data-sources/network_firewall_network_firewall_policy_service_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/7.19.0/docs/data-sources/network_firewall_network_firewall_policy_service_list oci_network_firewall_network_firewall_policy_service_list} Data Source
  *
  * @param scope The scope in which to define this construct
