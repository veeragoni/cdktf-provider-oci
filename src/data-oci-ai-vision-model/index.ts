// https://registry.terraform.io/providers/oracle/oci/6.37.0/docs/data-sources/ai_vision_model
...
export interface DataOciAiVisionModelConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/6.37.0/docs/data-sources/ai_vision_model#model_id DataOciAiVisionModel#model_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/6.37.0/docs/data-sources/ai_vision_model oci_ai_vision_model}
*/
export class DataOciAiVisionModel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAiVisionModel that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/6.37.0/docs/data-sources/ai_vision_model#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/6.37.0/docs/data-sources/ai_vision_model oci_ai_vision_model} Data Source
  *
  * @param scope The scope in which to define this construct
