// https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/apigateway_subscriber
...
export interface DataOciApigatewaySubscriberConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/apigateway_subscriber#subscriber_id DataOciApigatewaySubscriber#subscriber_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/apigateway_subscriber oci_apigateway_subscriber}
*/
export class DataOciApigatewaySubscriber extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciApigatewaySubscriber that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/apigateway_subscriber#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/apigateway_subscriber oci_apigateway_subscriber} Data Source
  *
  * @param scope The scope in which to define this construct
