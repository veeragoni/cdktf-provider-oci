// https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/bds_bds_instance_node_replace_configuration
...
export interface DataOciBdsBdsInstanceNodeReplaceConfigurationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/bds_bds_instance_node_replace_configuration#bds_instance_id DataOciBdsBdsInstanceNodeReplaceConfiguration#bds_instance_id}
  */
  readonly bdsInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/bds_bds_instance_node_replace_configuration#node_replace_configuration_id DataOciBdsBdsInstanceNodeReplaceConfiguration#node_replace_configuration_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/bds_bds_instance_node_replace_configuration oci_bds_bds_instance_node_replace_configuration}
*/
export class DataOciBdsBdsInstanceNodeReplaceConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciBdsBdsInstanceNodeReplaceConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/bds_bds_instance_node_replace_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/bds_bds_instance_node_replace_configuration oci_bds_bds_instance_node_replace_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
