// https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/database_management_external_db_home
...
export interface DataOciDatabaseManagementExternalDbHomeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/database_management_external_db_home#external_db_home_id DataOciDatabaseManagementExternalDbHome#external_db_home_id}
  */
  readonly externalDbHomeId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/database_management_external_db_home oci_database_management_external_db_home}
*/
export class DataOciDatabaseManagementExternalDbHome extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseManagementExternalDbHome that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/database_management_external_db_home#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/database_management_external_db_home oci_database_management_external_db_home} Data Source
  *
  * @param scope The scope in which to define this construct
