// https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/datascience_model_custom_metadata_artifact_content
...
export interface DataOciDatascienceModelCustomMetadataArtifactContentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/datascience_model_custom_metadata_artifact_content#id DataOciDatascienceModelCustomMetadataArtifactContent#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/datascience_model_custom_metadata_artifact_content#metadatum_key_name DataOciDatascienceModelCustomMetadataArtifactContent#metadatum_key_name}
  */
  readonly metadatumKeyName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/datascience_model_custom_metadata_artifact_content#model_id DataOciDatascienceModelCustomMetadataArtifactContent#model_id}
  */
  readonly modelId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/datascience_model_custom_metadata_artifact_content#range DataOciDatascienceModelCustomMetadataArtifactContent#range}
  */
  readonly range?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/datascience_model_custom_metadata_artifact_content oci_datascience_model_custom_metadata_artifact_content}
*/
export class DataOciDatascienceModelCustomMetadataArtifactContent extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatascienceModelCustomMetadataArtifactContent that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/datascience_model_custom_metadata_artifact_content#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/datascience_model_custom_metadata_artifact_content oci_datascience_model_custom_metadata_artifact_content} Data Source
  *
  * @param scope The scope in which to define this construct
