// https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/devops_trigger
...
export interface DataOciDevopsTriggerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/devops_trigger#trigger_id DataOciDevopsTrigger#trigger_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/devops_trigger oci_devops_trigger}
*/
export class DataOciDevopsTrigger extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDevopsTrigger that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/devops_trigger#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/devops_trigger oci_devops_trigger} Data Source
  *
  * @param scope The scope in which to define this construct
