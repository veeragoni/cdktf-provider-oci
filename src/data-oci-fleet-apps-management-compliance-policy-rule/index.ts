// https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/fleet_apps_management_compliance_policy_rule
...
export interface DataOciFleetAppsManagementCompliancePolicyRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/fleet_apps_management_compliance_policy_rule#compliance_policy_rule_id DataOciFleetAppsManagementCompliancePolicyRule#compliance_policy_rule_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/fleet_apps_management_compliance_policy_rule oci_fleet_apps_management_compliance_policy_rule}
*/
export class DataOciFleetAppsManagementCompliancePolicyRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciFleetAppsManagementCompliancePolicyRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/fleet_apps_management_compliance_policy_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/fleet_apps_management_compliance_policy_rule oci_fleet_apps_management_compliance_policy_rule} Data Source
  *
  * @param scope The scope in which to define this construct
