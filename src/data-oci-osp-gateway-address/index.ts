// https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/osp_gateway_address
...
export interface DataOciOspGatewayAddressConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/osp_gateway_address#address_id DataOciOspGatewayAddress#address_id}
  */
  readonly addressId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/osp_gateway_address#compartment_id DataOciOspGatewayAddress#compartment_id}
  */
  readonly compartmentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/osp_gateway_address#id DataOciOspGatewayAddress#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/osp_gateway_address#osp_home_region DataOciOspGatewayAddress#osp_home_region}
  */
  readonly ospHomeRegion: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/osp_gateway_address oci_osp_gateway_address}
*/
export class DataOciOspGatewayAddress extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciOspGatewayAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/osp_gateway_address#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/osp_gateway_address oci_osp_gateway_address} Data Source
  *
  * @param scope The scope in which to define this construct
