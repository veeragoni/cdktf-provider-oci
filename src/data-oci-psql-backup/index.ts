// https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/psql_backup
...
export interface DataOciPsqlBackupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/psql_backup#backup_id DataOciPsqlBackup#backup_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/psql_backup oci_psql_backup}
*/
export class DataOciPsqlBackup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciPsqlBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/psql_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/7.19.0/docs/data-sources/psql_backup oci_psql_backup} Data Source
  *
  * @param scope The scope in which to define this construct
